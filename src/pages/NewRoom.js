...
import { createRoom } from '../api/smart-contracts.api';

function NewRoom() {
  const [name, setName] = useState('');
  const [participants, setParticipants] = useState();

  async function createYourRoom() {
    
    await createRoom(localStorage.getItem('selectedArchetype'), participants);
  ...
  return (
    <NavAndSideBar>
      ...
      <Button primary margin="small" size="large" align="center" alignSelf="center" label="Create your Room" onClick={createYourRoom} />
    </NavAndSideBar>
  );
}
